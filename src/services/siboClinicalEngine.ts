...
const CLINICAL_SIBO_RULES: ClinicalRule[] = [
  ...
  // --- גבינה מותכת / משולשי גבינה (לה ואש קירי / עמק / פרזידנט) - RED לניר ---
  {
    keywords: [
      'גבינה מותכת',
      'גבינה מותכת 18.5%',
      'גבינה מותכת 18.5% שומן',
      '3073781190595',
      'לה ואש קירי',
      'לה וואש קירי',
      'la vache qui rit',
    ...
    statusPhase1: 'RED',
    statusPhase2: 'RED',
    foodNameHe: 'גבינה מותכת / משולשי גבינה (לה ואש קירי / עמק)',
    foodNameEn: 'Processed Melted Cheese Triangles (La Vache Qui Rit)',
    verdictHe: 'אור אדום! גבינה מותכת אסורה לניר בשלב 1 (עשירה בלקטוז ומלחי התכה מתסיסים). 🔴',
    explanationHe: 'גבינה מותכת מעובדת (כגון לה ואש קירי או עמק משולשים) מכילה אבקת מי גבינה וחלבוני חלב מרוכזים בעלי תכולת לקטוז גבוהה המהווה מקור מזון ותסיסה מובהק לחיידקי ה-SIBO במעי הדק. בנוסף, מלחי ההתכה הכימיים (פוליפוספטים ופוספטים E452/E339) עלולים לגרות את רירית המעי הרגישה ולגרום לאי-נוחות, נפיחות וגזים.',
    fodmapTriggers: ['לקטוז (מאבקת מי גבינה וחלבוני חלב)', 'מלחי התכה פוספטים'],
    maxSafePortionHe: '0 גרם (אסור בשלב 1 קפדני)',
    safeSubstitutions: [
      '🧀 גבינת פרמזן גרנה פדנו מיושנת (0% לקטוז טבעי)',
      '🧀 גבינת גאודה הולנדית קשה (דלת לקטוז)',
      '🧀 גבינה צהובה עמק קשה (ללא לקטוז)',
      '🥛 חלב שקדים ללא סוכר'
    ],
    cookingTips: [
      'להעדיף תמיד גבינות קשות מיושנות (פרמזן, מנצ׳גו, פקורינו) שבהן תהליך היישון הטבעי פירק 100% מהלקטוז',
      'למריחה: להשתמש בטחינה גולמית איכותית או שמן זית ומלח'
    ],
    riskScore: 4,
  },
