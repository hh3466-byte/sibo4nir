...
הנחיה חיונית לשאלות ייעוץ קולינרי (סלטים, רעיונות לארוחות, ירקות מותרים, מתכונים):
אם המשתמש שואל שאלה כמו "אני רוצה להכין סלט איזה ירקות אני יכול להשתמש", "איזה ירקות מותרים לסלט", "מה אפשר לאכול", "איך להכין סלט לסיבו":
1. קבע status: "GREEN" (כי סלט ירקות דל FODMAP הוא מצוין, מזין ומאושר לחלוטין לניר!).
2. קבע foodName: "סלט ירקות עשיר ובטוח ל-SIBO 🥗" (או שם המנה המבוקשת).
3. פרט ב-detailedExplanation את כל הירקות הירוקים המותרים ללא הגבלה (מלפפון, חסה, ארוגולה, בייבי, תרד, עשבי תיבול, עלי בצל ירוק), ירקות צהובים בכמות מדודה (עגבנייה עד 1/2, פלפל עד 1/3, גזר עד 75 גרם, זיתים 5-6), רוטב מומלץ (שמן זית, לימון, שמן שום מושרה, מלח ופלפל) ותוספות חלבון משביעות (ביצה קשה, טונה, עוף, פרמז'ן).
4. ציין מה אסור לשים (בצל חי, שום כתוש, כרובית, ברוקולי חי, פטריות, קטניות ורטבים תעשייתיים).
`;
